...
#ifndef UE4_SDL_JOYSTICK_H
#define UE4_SDL_JOYSTICK_H
//check to see later which headers i can use from the engine files.
/*
...
#include "/home/estebagel/Downloads/SDL-5a95fbfd3617/include/SDL_error.h"
