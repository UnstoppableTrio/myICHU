...
//#include "ICHUTypes.h"
//#include "ICHUInventoryInterface.h"

#pragma once

#include "CoreMinimal.h"
#include "GameFramework/PlayerController.h"
#include "ICHUPlayerController.generated.h"

/** Base class for PlayerController, should be blueprinted */
UCLASS()
class MYICHU_API AICHUPlayerController : public APlayerController//, public IICHUInventoryInterface
{
GENERATED_BODY()

public:
    //Constructor and overrides
	AICHUPlayerController() {}
...
//	TMap<UICHUItem*, FICHUItemData> InventoryData;

	/** Map of slot, from type/num to item, initialized from ItemSlotsPerType on ICHUGameInstanceBase */
//	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Inventory)
//	TMap<FICHUItemSlot, UICHUItem*> SlottedItems;
...
//	bool LoadInventory();
	...
	// Implement IICHUInventoryInterface
/*	virtual const TMap<UICHUItem*, FICHUItemData>& GetInventoryDataMap() const override
	{
		return InventoryData;
	}
	virtual const TMap<FICHUItemSlot, UICHUItem*>& GetSlottedItemMap() const override
	{
		return SlottedItems;
	}
...
//	bool FillEmptySlotWithItem(UICHUItem* NewItem);

	/** Calls the inventory update callbacks */
//	void NotifyInventoryItemChanged(bool bAdded, UICHUItem* Item);
//	void NotifySlottedItemChanged(FICHUItemSlot ItemSlot, UICHUItem* Item);
