...
#include "/home/estebagel/UE_4.20-unstoppable/Engine/Source/ThirdParty/SDL2/SDL-gui-backend/src/timer/SDL_timer_c.h"
...
#define SDL_EVENT_CASE(x) \
    case x:               \
        ...
        printf("(timestamp=%u)", (uint)event->quit.timestamp);
        break;
...
#define SDL_EVENT_CASE(x) \
    case x:               \
        ...
        case SDL_WINDOWEVENT_NONE:
            printf("none(THIS IS PROBABLY A BUG!)");
            break;
