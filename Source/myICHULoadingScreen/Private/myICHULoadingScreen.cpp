...
{
    FICHULoadingScreenBrush(const FName InTextureName, const FVector2D& InImageSize)
...
class SICHULoadingScreen : public SCompoundWidget
{
public:
    SLATE_BEGIN_ARGS(SICHULoadingScreen) {}
    SLATE_END_ARGS()
    ...
    void Construct(const FArguments& InArgs)
    {
        ...
        [
                ...
                [
                        ...
                        [
                                SNew(SThrobber)
                                        .Visibility(this, &SICHULoadingScreen::GetLoadIndicatorVisibility)
                        ]
                ]
        ];
    }
...
class FmyICHULoadingScreenModule : public ImyICHULoadingScreenModule
{
public:
    ...
    virtual void StartInGameLoadingScreen(bool bPlayUntilStopped, float PlayTime) override
    {
        ...
        LoadingScreen.WidgetLoadingScreen = SNew(SICHULoadingScreen);
...
IMPLEMENT_GAME_MODULE(FmyICHULoadingScreenModule, myICHULoadingScreen);
